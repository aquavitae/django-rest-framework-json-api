...
def format_type_name(name, format_type=None):
    """
    Takes a single name and returns it with pluralized and formatted
...
def get_related_resource_type(relation):
    ...
    return format_type_name(relation_model.__name__)
